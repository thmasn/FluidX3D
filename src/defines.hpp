...
#define GRAPHICS_FRAME_WIDTH 1920/2 // set frame width if only GRAPHICS is enabled
#define GRAPHICS_FRAME_HEIGHT 1080/2 // set frame height if only GRAPHICS is enabled
...
#define GRAPHICS_STREAMLINE_SPARSE 16 // set how many streamlines there are every x lattice points
